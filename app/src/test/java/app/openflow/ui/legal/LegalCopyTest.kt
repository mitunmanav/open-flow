...
class LegalCopyTest {
    ...
    @Test
    fun privacy_is_sectioned() {
        assertThat(LegalCopy.privacySections.map { it.title }).containsExactly(
            "What this app uses",
            "Honest about speech",
        ...
        assertThat(LegalCopy.privacyIntro.lowercase()).contains("no account")
        assertThat(LegalCopy.privacyBody).contains("Accessibility")
        assertThat(LegalCopy.privacyIntro).isNotEmpty()
        assertThat(LegalCopy.termsSections).isNotEmpty()
        assertThat(LegalCopy.termsIntro).isNotEmpty()
    }
}
