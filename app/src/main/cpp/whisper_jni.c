...
#define TAG "OpenFlowWhisper"
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO, TAG, __VA_ARGS__)

JNIEXPORT jlong JNICALL
Java_app_openflow_whisper_WhisperLib_00024Companion_initContext(
...
Java_app_openflow_whisper_WhisperLib_00024Companion_freeContext(
...
Java_app_openflow_whisper_WhisperLib_00024Companion_getTextSegmentCount(
        JNIEnv *env, jobject thiz, jlong context_ptr) {
    UNUSED(env);
    UNUSED(thiz);
...
Java_app_openflow_whisper_WhisperLib_00024Companion_getTextSegment(
...
JNIEXPORT jstring JNICALL
Java_app_openflow_whisper_WhisperLib_00024Companion_getSystemInfo(
