...
class PrivacyDefaultsTest {
    ...
    fun nsc_public_https_only_cleartext_is_listed_lan() {
        ...
        assertThat(xml).contains("<domain includeSubdomains=\"false\">127.0.0.1</domain>")
        assertThat(xml).contains("<domain includeSubdomains=\"false\">10.0.2.2</domain>")
        assertThat(xml).contains("<domain includeSubdomains=\"false\">192.168.1.1</domain>")
