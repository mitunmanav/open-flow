...
- The Open Flow APK does **not** declare the INTERNET permission.
- History stays on this phone unless you share it.
- You can wipe after 24 hours, or never save.
...
**Storage**  
Transcripts you keep, dictionary, snippets, and settings. App-private. Backup to the cloud is off.

## Honest about speech

Open Flow does not upload audio.  
...
- Settings in the app: keep / wipe 24h / never store.
